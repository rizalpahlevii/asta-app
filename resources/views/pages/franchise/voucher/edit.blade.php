                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <form method="POST" class="needs-validations"
                                    action="{{ route('franchise.voucher.update',$voucher->id) }}" novalidate>
                                    @csrf
                                    @method('PUT')
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-6">
                                            <input type="text" name="name"
                                                ...
                                                placeholder="Voucher Name" value="{{ $voucher->name }}">
                                            @error('name')
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-6">
                                            <input type="text" name="code"
                                                ...
                                                placeholder="Voucher Code" value="{{
                                                    $voucher->code }}">
                                            @error('code')
                                            <div class="invalid-feedback">{{ $message }}</div>
                                            @enderror
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-6">
                                            <input type="number" name="nominal_value"
                                                ...
                                                id="nominal_value" placeholder="Nominal Value" value="{{
                                                    $voucher->nominal_value }}">
                                            @error('nominal_value')
                                            <div class="invalid-feedback">{{ $message }}</div>
                                            @enderror
                                        </div>
                                    ...
                                    <div class="form-group row">
                                        <label for="remaining_quota" class="col-sm-2 col-form-label">Remaining
                                            Quota</label>
                                        <div class="col-sm-6">
                                            <input type="number" name="remaining_quota"
                                                class="form-control @error('remaining_quota') is-invalid @enderror"
                                                id="remaining_quota" placeholder="Initial Quota"
                                                value="{{ $voucher->remaining_quota }}">
                                            @error('remaining_quota')
                                            <div class="invalid-feedback">{{ $message }}</div>
                                            @enderror
                                        </div>
                                    </div>
                                    ...
                                    <input type="submit" name="submit" value="Update Voucher "
