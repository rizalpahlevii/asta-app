...
<div class="hk-pg-header">
    ...
    <div class="row">
        <div class="col-md-12">
            <a href="{{ route('admin.franchise.franchise_pdf') }}" class="btn btn-primary btn-rounded btn-sm ">Export
                PDF
            </a>
            <a href="{{ route('admin.franchise.create') }}" class="btn btn-primary btn-rounded btn-sm ">Create
                Franchise
            </a>
